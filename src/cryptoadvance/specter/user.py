...
class User(UserMixin):
    ...
    def get_all_jwt_token_ids_and_descriptions(self):
        ...
        return [(jwt_token_id, self.jwt_tokens[jwt_token_id]['jwt_token_description']) for jwt_token_id in self.jwt_tokens]
    ...
    def unique_jwt_token_description(self, jwt_token_description):
        ...
        return jwt_token_description not in [self.jwt_tokens[jwt_token_id]['jwt_token_description'] for jwt_token_id in self.jwt_tokens]
