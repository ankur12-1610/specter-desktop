...
class ResourceJWT(SecureResource):
    ...
    def post(self):
        ...
        if(user_details.unique_jwt_token_description(jwt_token_description)):
            ...
            return {"message": "Token generated", "jwt_token_id": jwt_token_id, 'jwt_token': jwt_token, 'jwt_token_description': jwt_token_description}, 201
        else:
            return {"message": "Token description already exists, please enter a new one"}, 400
        # user_details.add_jwt_token(jwt_token_id, jwt_token, jwt_token_description)
        # return {"message": "Token created", "jwt_token_id": jwt_token_id, 'jwt_token': jwt_token, 'jwt_token_description': jwt_token_description}, 201
